      ...
      repos: {
        ...
        'mfx-ui-admin-v3': {
          projects: {
            ...
            'lgmfyc': {
              bucket: 'mfx-v2-staging-admin3-fe-lgmfyc',
              distribution_ids: SCRAMBLED:5PLap8LXNuzyj95BHBGlzWYqUd1rO4y1rfFE1a4iixHCapr9OS+ytBW12Qp1TfTv/C44pwEi45fxks9J
            },
          },
        },
        'mfx-ui-eone': {
      ...
      repos: {
        'mpx-ui-admin': {
          projects: {
            ...
            'lgt': {
              ...
              distribution_ids: SCRAMBLED:89DUr+PBBavJ6MgjOzyo2K71AVWGWSprAOXUMj4whTx1MdofaTmbDHw6BC1vlL1kM88oB22+PmIPHo9W
            },
            'itv': {
        ...
        'mfx-ui-gcui2': {
          projects: {
            ...
            'crunchyroll': {
              bucket: 'mfx-v2-presentation-buyer-fe-crunchyroll',
              distribution_ids: SCRAMBLED:yfDDgIf2Ko2nwI8jCAeK/+3RpR2eVvAFXj9iqJrcuTMa4GxkH+4x286jvrn1PCBZAyZt0/rTAe8DNMBQ
            },
            'electric': {
        ...
        'mfx-ui-admin-v3': {
          projects: {
            'generic': {
              bucket: 'mfx-v2-presentation-admin3-fe-generic', // for iemmys, mcentral, amazonapac, trial1 - trial10 (demo sites) (i.e. only product3 affils)
              distribution_ids: SCRAMBLED:xMva4MDzdY7R3uhFLQbhw5nUfKrFILLnGodXas+Uq3zifWV+tP5wXVkk49wMQleaEpUfefvmpdTOo0pi
            },
            'generic-mm3': {
              bucket: 'mfx-v2-presentation-admin3-fe-generic-mm3', // for mfx, alu, amazonus (i.e. asset3 + product3 affils)
              distribution_ids: SCRAMBLED:8MDpqOPUO47G/PglD2+h3zJafs4BHbp7IToLjyAgIvmaP1iLWNwdKGk+g8bqfpI47RhwRVmUAHROZFwy
            },
            'itvstudios': {
            ...
            'mfx': {
              bucket: 'mfx-v2-presentation-admin3-fe-mfx',
              distribution_ids: SCRAMBLED:8MDpqOPUO47G/PglD2+h3zJafs4BHbp7IToLjyAgIvmaP1iLWNwdKGk+g8bqfpI47RhwRVmUAHROZFwy
            },
            'lgt': {
            ...
            'lgmpg': {
              bucket: 'mfx-v2-presentation-admin3-fe-lgmpg',
              distribution_ids: SCRAMBLED:7MrSjP7BMKilwJJEOSHk8x1VAmjSt1hWg/lBRfKJP0dioycZSnSlOefOVjumit+27WIEir7iCEfDjJue
            },
            'lgmfyc': {
      ...
      repos: {
        'mpx-ui-admin': {
          projects: {
            'generic': {
              ...
              // Cloudfront distribution ids for (in this order): generic (mediastore.app domains), dmd, relativity, ftd, filmrise:
              distribution_ids: SCRAMBLED:4dWpqZrwIZL67O9XFT++13KtLzrAdtfOH1/XqXZTe7V+ZFPIuq4XCu3Iw/c9BWZbz3rhtSkqr8QRuGRaOCMHEca8HaJxtW/YLnRScycVsYFrVn+D2dHuym5p+5zlk3LGhAcWFmZe08ry6GnK4joMqXq3XL4edFtvBVqKGi6DDtjWSSLj7tm+fHsSj0sVYjix62uC/qzTE/OvD5iM
            },
            'bavaria': {
        ...
        'mfx-ui-gcui2': {
          projects: {
            ...
            'crunchyroll': {
              bucket: 'mfx-v2-production-buyer-fe-crunchyroll',
              distribution_ids: SCRAMBLED:x4rAv8XXKY/Xx+x9JwyyzoKo45yR5A+grRAvi3SYKHgAp12O7v1aU6KQk+GiR6DcLTZCj1koD8FQV+hp
            },
            'electric': {
